...
var G__21291 = o;
(G__21291[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21295 = o;
(G__21295[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21300 = props;
var G__21300__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21300,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21300);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21300__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21301){
...
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21302,map__21302__$1,props,class$){
return (function (c){
...
});})(map__21302,map__21302__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21304){
var map__21305 = p__21304;
var map__21305__$1 = (((((!((map__21305 == null))))?(((((map__21305.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21305.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21305):map__21305);
var on_write = cljs.core.get.call(null,map__21305__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21305,map__21305__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21305,map__21305__$1,on_write))
);
} else {
...
var G__21308 = jsprops;
(G__21308["defaultValue"] = value);

(G__21308["onChange"] = ((function (G__21308,v,value,on_change){
return (function (p1__21307_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21307_SHARP_);
});})(G__21308,v,value,on_change))
);
...
var vec__21312 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21312,(0),null);
var id = cljs.core.nth.call(null,vec__21312,(1),null);
var class$ = cljs.core.nth.call(null,vec__21312,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___21316 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___21316 == null)){
} else {
var key_21317 = temp__5724__auto___21316;
(jsprops["key"] = key_21317);
}
...
var temp__5724__auto___21318 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___21318 == null)){
} else {
var key_21319 = temp__5724__auto___21318;
reagent.impl.template.oset.call(null,jsprops,"key",key_21319);
}
...
var G__21320 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21320["name"] = c);
...
args__4736__auto__.push((arguments[i__4731__auto___21327]));
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21324){
var G__21325 = cljs.core.first.call(null,seq21324);
var seq21324__$1 = cljs.core.next.call(null,seq21324);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21325,seq21324__$1);
});
...
break;
default:
var G__21331 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21331;
continue;
...
var n__4607__auto___21333 = a.length;
var i_21334 = (0);
while(true){
if((i_21334 < n__4607__auto___21333)){
(a[i_21334] = reagent.impl.template.as_element.call(null,(a[i_21334])));

var G__21335 = (i_21334 + (1));
i_21334 = G__21335;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___21336 = a.length;
var i_21337 = (0);
while(true){
if((i_21337 < n__4607__auto___21336)){
var val_21338 = (a[i_21337]);
if(((cljs.core.vector_QMARK_.call(null,val_21338)) && ((reagent.impl.template.key_from_vec.call(null,val_21338) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21337] = reagent.impl.template.as_element.call(null,val_21338));
...
var ctx = ({});
var vec__21340 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21340,(0),null);
var derefed = cljs.core.nth.call(null,vec__21340,(1),null);
...
var G__21343 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21343) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21343){
...
//# sourceMappingURL=template.js.map?rel=1579862639999
