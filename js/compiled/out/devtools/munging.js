...
var o22034 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22034["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22035 = temp__5718__auto____$1;
return (o22035["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21146__auto__ = f;
return (o__21146__auto__["toString"]).call(o__21146__auto__);
} else {
return "";
}
}catch (e22036){var _ = e22036;
return "";
}});
...
try{var o__21146__auto___22038 = t;
(o__21146__auto___22038["cljs$lang$ctorPrWriter"]).call(o__21146__auto___22038,t,writer);
}catch (e22037){var __22039 = e22037;
}
...
var char_code = (function (){var o__21146__auto__ = (new String(char$));
return (o__21146__auto__["charCodeAt"]).call(o__21146__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21146__auto__ = String;
return (o__21146__auto__["fromCharCode"]).call(o__21146__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22040 = num_code;
switch (G__22040) {
case (1):
return (185);
...
var o__21146__auto__ = String;
return (o__21146__auto__["fromCharCode"]).call(o__21146__auto__,superscript_code);
});
/**
...
}catch (e22042){var _e__21153__auto__ = e22042;
return false;
}})())){
...
var vec__22043 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22043,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o22046 = temp__5718__auto__;
var temp__5718__auto____$1 = (o22046["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o22047 = temp__5718__auto____$1;
return (o22047["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___22054 = arguments.length;
var i__4731__auto___22055 = (0);
while(true){
if((i__4731__auto___22055 < len__4730__auto___22054)){
args__4736__auto__.push((arguments[i__4731__auto___22055]));

var G__22056 = (i__4731__auto___22055 + (1));
i__4731__auto___22055 = G__22056;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22050){
var vec__22051 = p__22050;
var ns_detector = cljs.core.nth.call(null,vec__22051,(0),null);
...
var G__22057 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22058 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22057;
remaining_tokens = G__22058;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22048){
var G__22049 = cljs.core.first.call(null,seq22048);
var seq22048__$1 = cljs.core.next.call(null,seq22048);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22049,seq22048__$1);
});
...
var vec__22062 = cljs.core.split_with.call(null,(function (p1__22061_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22061_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22062,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22062,(1),null);
...
var vec__22068 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22068,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22068,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22071 = cljs.core.rest.call(null,remaining_tokens);
var G__22072 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22071;
name_tokens = G__22072;
continue;
} else {
...
var vec__22075 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22075,(0),null);
var arity = cljs.core.nth.call(null,vec__22075,(1),null);
var vec__22078 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22078,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22078,(1),null);
var vec__22081 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22081,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22081,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22081,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22081,(3),null);
...
var vec__22087 = result;
var munged_ns = cljs.core.nth.call(null,vec__22087,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22087,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22087,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22087,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22087,(4),null);
var arity = cljs.core.nth.call(null,vec__22087,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__22091 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__22091,(0),null);
var args = cljs.core.nth.call(null,vec__22091,(1),null);
var vec__22094 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22094,(0),null);
var name = cljs.core.nth.call(null,vec__22094,(1),null);
...
var G__22097 = (arity + (1));
var G__22098 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22099){
var vec__22100 = p__22099;
var arity = cljs.core.nth.call(null,vec__22100,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22100,(1),null);
...
return cljs.core.get.call(null,arities,p1__22103_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22104_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22107){
var vec__22108 = p__22107;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22108,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22105){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22116__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22116__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22116__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22116__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22117 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22117,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22117,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22117,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22117,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22117,(4),null);
var arity = cljs.core.nth.call(null,vec__22117,(5),null);
...
var o__21146__auto__ = f;
return (o__21146__auto__["getBasis"]).call(o__21146__auto__);
});
/**
...
}catch (e22121){var _e__21153__auto__ = e22121;
...
var G__22122 = (obj[cljs.core.first.call(null,path)]);
var G__22123 = cljs.core.rest.call(null,path);
obj = G__22122;
path = G__22123;
continue;
} else {
...
return (function (accum,p__22124){
var vec__22125 = p__22124;
var bit = cljs.core.nth.call(null,vec__22125,(0),null);
var protocol = cljs.core.nth.call(null,vec__22125,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22128){
var vec__22129 = p__22128;
var ns = cljs.core.nth.call(null,vec__22129,(0),null);
var name = cljs.core.nth.call(null,vec__22129,(1),null);
var selector = cljs.core.nth.call(null,vec__22129,(2),null);
...
return (function (p__22133){
var vec__22134 = p__22133;
var munged_name = cljs.core.nth.call(null,vec__22134,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22134,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22134,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22132_SHARP_){
return (obj[cljs.core.first.call(null,p1__22132_SHARP_)]);
});})(name,sorted_matches,vec__22134,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1579862703284
