...
}catch (e23305){var _e = e23305;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___23308 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___23308)){
var seen_errors_23309 = temp__5718__auto___23308;
if(cljs.core.truth_(seen_errors_23309.has(self))){
} else {
seen_errors_23309.add(self);

var temp__5720__auto___23310 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___23310)){
var sense_23311 = temp__5720__auto___23310;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_23311)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1579862705461
