...
return (new CustomEvent(event_name,(function (){var obj26747 = ({"detail":data});
return obj26747;
})()));
} else {
...
var f = (function (){var pred__26754 = cljs.core._EQ_;
var expr__26755 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26754.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26755))){
return ((function (pred__26754,expr__26755){
return (function (p1__26748_SHARP_){
return console.warn(p1__26748_SHARP_);
});
;})(pred__26754,expr__26755))
} else {
if(cljs.core.truth_(pred__26754.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26755))){
return ((function (pred__26754,expr__26755){
return (function (p1__26749_SHARP_){
return console.debug(p1__26749_SHARP_);
});
;})(pred__26754,expr__26755))
} else {
if(cljs.core.truth_(pred__26754.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26755))){
return ((function (pred__26754,expr__26755){
return (function (p1__26750_SHARP_){
return console.error(p1__26750_SHARP_);
});
;})(pred__26754,expr__26755))
} else {
return ((function (pred__26754,expr__26755){
return (function (p1__26751_SHARP_){
return console.log(p1__26751_SHARP_);
});
;})(pred__26754,expr__26755))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26758){
var map__26759 = p__26758;
var map__26759__$1 = (((((!((map__26759 == null))))?(((((map__26759.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__26759.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26759):map__26759);
var opts = map__26759__$1;
var eval_fn = cljs.core.get.call(null,map__26759__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26761_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__26763,(0),null);
var v = cljs.core.nth.call(null,vec__26763,(1),null);
...
}catch (e26768){if((e26768 instanceof Error)){
var e = e26768;
return not_found;
} else {
throw e26768;
...
//# sourceMappingURL=utils.js.map?rel=1579862707353
